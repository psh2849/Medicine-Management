...
import com.example.healthcareapp.ui.fragment.favorite.FavoriteFragmentDirections
...
class FavoriteBindingAdapter {
    companion object {
        ...
        @JvmStatic
        fun onFavoriteClickListener(medicineRowLayout: ConstraintLayout, item: Item) {
